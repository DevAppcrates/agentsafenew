                        ...
                        <div class="p-3 location" style="padding: 10px !important;height: auto;">
                            {{-- {{ $video->lost_person }} --}}
                             ...
                             @if(isset($video->lost_person['agent_Phone']))
                                ...
                                <input readonly class="form-control" type="text" name="agent_Phone" id="l_name" value="<?php echo $video->lost_person['agent_Phone'] ?? '' ?>"><br/>
                             @endif

                             @if(isset($video->lost_person['address']))
                                <label class="form-label">Showing Address</label>
                                <input readonly class="form-control" type="text" name="address" id="l_name"  value="<?php echo $video->lost_person['address'] ?? '' ?>"><br/>
                             @endif

                             @if(isset($video->lost_person['time']))
                                <label class="form-label">Showing Time</label>
                                <input readonly class="form-control" type="text" name="time" id="l_name"  value="<?php echo $video->lost_person['time'] ?? '' ?>"><br/>
                             @endif

                              @if(isset($video->lost_person['message']))
                                <label class="form-label">Message body</label>
                                <textarea readonly  rows="4" class="form-control" type="text" name="message" id="l_name"><?php echo $video->lost_person['message'] ?? '' ?></textarea>
                                <br/>
                             @endif
            ...
            @if($video->type == 'lost_person')
                <div class="col-md-5">
                    ...
                    <div class="p-3 location" style="padding: 10px !important;height: 500px;">
                            ...
                            <input readonly autocomplete="off"  class="form-control" type="text" name="name" id="l_name" value="<?php echo $user->first_name . ' ' . $user->last_name ?>"><br/>
                            <label class="form-label">Email</label>
                            <input readonly autocomplete="off" class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->user->email ?>"><br/>
                            <label class="form-label">Phone</label>
                            <input readonly autocomplete="off" class="form-control" type="text" name="name" id="l_name"  value="<?php echo $user->phone_number ?>"><br/>
                            <label class="form-label">Address</label>
                            <input readonly autocomplete="off" class="form-control" type="text" name="name" id="l_name"  value="<?php echo $user->user_address->address_1 . ' ' . $user->user_address->address2_m ?>"><br/>
                   </div>
                </div>
            @else
                <div class="col-md-6">
                    ...
                    <div class="p-3 location" style="padding: 10px !important;height: auto;">
                         ...
                         @if($video->messmessage['name']!=null)
                            <label class="form-label">Name</label>
                            <input readonly class="form-control" type="text" name="name" id="l_name" value="<?php echo $video->message['name'] ?>"><br/>
                         @endif

                         @if($video->message['phone']!=null)
                            <label class="form-label">Phone</label>
                            <input readonly class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->message['phone'] ?>"><br/>
                         @endif

                         @if($video->message['subject']!=null)
                            <label class="form-label">Subject</label>
                            <input readonly class="form-control" type="text" name="name" id="l_name"  value="<?php echo $video->message['subject'] ?>"><br/>
                         @endif

                         @if($video->message['message']!=null)
                            <label class="form-label">Message</label>
                            <textarea readonly class="form-control" style="min-height:150px"><?php echo $video->message['message'] ?></textarea>
                         @endif
            ...
            <div class="modal-body">
                <form class="form-group" id="add-sub-contact-center"  novalidate="novalidate">
                    ...
                    <div class="col-md-8">
                        ...
                        <input readonly class="form-control" type="text" name="name" id="f_name" placeholder="First Name">
                        <br>
                        <label class="form-label">Last Name</label>
                        <input readonly class="form-control" type="text" name="name" id="l_name" placeholder="Last Name">
                        <br>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input readonly class="form-control" type="text" name="name" id="email" placeholder="Email">
                        <br>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Phone No</label>
                        <input readonly class="form-control" type="text" id="phone" placeholder="Phone No">
                        <br>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label"> Date of birth</label>
                        <input readonly class="form-control" type="text" id="dob" placeholder="Date of birth">
                        <br>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Address 1</label>
                        <input readonly class="form-control" type="text" id="add1" placeholder="Address 1">
                        <br>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Address 2</label>
                        <input readonly class="form-control" type="text" id="add2" placeholder="Address 2">
                        <br>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">City</label>
                        <input readonly class="form-control" type="text" id="city" placeholder="City">
                        <br>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">State</label>
                        <input readonly class="form-control" type="text" id="state" placeholder="State">
                        <br>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Zipcode</label>
                        <input readonly class="form-control" type="text" id="zipcode" placeholder="Zipcode">
                        <br>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Country</label>
                        <input readonly class="form-control" type="text" id="country" placeholder="Country">
                        <br>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">Illness allergies</label>
                        <input readonly class="form-control" type="text" id="illness_allergies" placeholder="Illness allergies">
                        <br>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Dr name</label>
                        <input readonly class="form-control" type="text" id="dr_name" placeholder="Dr name">

                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Dr phone</label>
                        <input readonly class="form-control" type="text" id="dr_phone" placeholder="Dr phone">
                        <br>
                    </div>
                    ...
                    <input readonly class="form-control" type="text" name="address" placeholder="Address" style="opacity: 0">
    ...
    $('#user_detail #user_emergency_contacts').empty();
       ...
       if(contacts.length != 0 )
        ...
        $.each(contacts,function(k,v){
              ...
              markup += '<input readonly class="form-control" type="text" id="emergency_contact_'+i+'_name" value="'+(v.name? v.name: "N/A")+'" placeholder="Dr phone">'
              markup += '</div>'
              markup += '<div class="col-md-6">'
              markup += '<label class="form-label">Emergency Contact '+i+' Relation</label>'
              markup += '<input readonly class="form-control" type="text" id="emergency_contact_'+i+'_relation" value="'+(v.relation? v.relation : "N/A")+'" placeholder="Contact phone No:">'
              markup += '</div>'
              markup += '<div class="col-md-12">'
              markup += '<label class="form-label">Emergency Contact '+i+' Phone</label>'
              markup += '<input readonly class="form-control" type="text" id="emergency_contact_'+i+'_phone" value="'+(v.phone? v.phone : "N/A")+'" placeholder="Contact phone No:">'
              markup += '</div>'
    i++;
        ...
        for (var i = 1; i <= 2; i++) {
              ...
              markup += '<div class="col-md-6">'
              markup += '<label class="form-label">Emergency Contact '+i+'</label>'
              markup += '<input readonly class="form-control" type="text" id="emergency_contact_'+i+'_name" placeholder="Emergency Contact name">'
              markup += '</div>'
              markup += '<div class="col-md-6">'
              markup += '<label class="form-label">Emergency Contact '+i+' Relation</label>'
              markup += '<input readonly class="form-control" type="text" id="emergency_contact_'+i+'_relation" placeholder="Emergency Contact\'\s Relation">'
              markup += '</div>'
              markup += '<div class="col-md-12">'
              markup += '<label class="form-label">Emergency Contact '+i+' Phone</label>'
              markup += '<input readonly class="form-control" type="text" id="emergency_contact_'+i+'_phone" placeholder="Emergency Contact phone No:">'
              markup += '</div>'
        }
    }
