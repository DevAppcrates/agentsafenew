...
@section('title')
    {{ config('app.name') }} | @if($values === 'pending_safewalk') Active SafeWalks @else Ended SafeWalks @endif
@stop
@section('css')
                                ...
                                <div class="portlet light bg-inverse">
                                    <div class="portlet-title">
                                        <div class="caption font-green-sharp">
                                            ...
                                            <span class="caption-subject"> @if($values === 'pending_safewalk') Active Safe Walks @else Ended Safe Walks @endif</span>
